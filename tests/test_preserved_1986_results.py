...
class Preserved1986ResultTests(unittest.TestCase):
    def test_all_r2_blocks_pass_strict_decoding(self):
        result_root = ROOT / "bench/results/1986-7556c23-2026-09-24-r2"
        cases = {
            parse_bench: (
    ...
    def test_uncontrolled_timer_b_diagnostic_is_rejected(self):
        path = (
            ROOT
            / "bench/results/1986-7556c23-2026-09-24-r2/diagnostics"
            / "irq-service-8502-1mhz-uncontrolled-timer-b.bin"
        )
        with self.assertRaisesRegex(ValueError, r"0x81/0x83"):
            parse_irq_service(path.read_bytes())
